    ...
    <div className="relative w-[1920px] overflow-x-hidden">
      ...
      <div className="flex justify-between items-center  text-white pl-[92px]  h-[940px] overflow-hidden">
        ...
        <section className="mt-[-100px]">
          ...
          <div className="h-[96px]">
            <h1 className="font-Russo template flex">T<TypinAnimation /></h1>
          </div>
        ...
        <section className="  relative flex ">
          <div className="flex flex-col gap-[135px] items-center">
            ...
            <img src={cloude} alt="" width={165} className="mr-[-100px] " />
          </div>
      ...
      <>
        ...
        <img
          src={plus}
          alt=""
          className="w-[50px] h-[50px] absolute left-[651px] top-[650px] rotatate-[45deg] floating"
